...
This MCP (Model Content Protocol) server provides access to Adobe Experience Manager (AEM) API API functionality through HTTP, HTTPS, and STDIO transport modes.
