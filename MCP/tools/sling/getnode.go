...
func GetnodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/%s/%s", cfg.BaseURL, path, name)
...
func CreateGetnodeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_path_name",
		mcp.WithDescription(""),
