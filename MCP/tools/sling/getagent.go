...
func GetagentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetagentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_etc_replication_agents.runmode_name",
		mcp.WithDescription(""),
