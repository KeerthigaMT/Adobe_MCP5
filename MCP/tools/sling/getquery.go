...
func GetqueryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetqueryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_bin_querybuilder.json",
		mcp.WithDescription(""),
